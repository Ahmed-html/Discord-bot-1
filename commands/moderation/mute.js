...
module.exports.run = async (client, message, args) => {
	...
	const notice3 = new Discord.MessageEmbed()
		.setDescription(`:x: I don't have permission to mute people! So not halal mode.`)
		.setColor("RED");
	...
	const embed50 = new Discord.MessageEmbed()
		...
		.setDescription("Usage: !mute @user [length] [reason]")
		.setColor("RED");

	if (!tomute) return message.channel.send(embed50);

	const notice2 = new Discord.MessageEmbed()
		.setDescription(`:x: You cannot mute yourself, idiot.`)
		.setColor("RED");
	...
	const sdfsdfsdfsssd = new Discord.MessageEmbed()
		.setDescription(`:x: Idiot, type how long u want to mute them for!`)
		.setColor("RED");
	const dddfs = new Discord.MessageEmbed()
		.setDescription(
			":x: You can only maxium muting this user for 14 days, just use `!kick`, idiot"
		)
		.setColor("RED");
	...
	const bruhembed = new Discord.MessageEmbed()
		.setDescription(
			`:x: **${tomute.username}#${tomute.discriminator}** had been muted before!`
		)
		.setColor("BLUE");
	...
	const embed10 = new Discord.MessageEmbed()
		.setDescription(
			`:white_check_mark: Muted **${tomute.username}#${tomute.discriminator}** | **${reason}**`
		)
		.setColor("BLUE");
...
module.exports.help = {
	name: "mute",
	description: "This command is used for muting some really annoying people. aka: Luis.",
