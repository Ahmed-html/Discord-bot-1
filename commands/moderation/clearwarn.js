...
module.exports.run = async (client, message, args) => {
	...
	const notice3 = new Discord.MessageEmbed()
		.setDescription(`:x: I don't have permission to warn people, idiot`)
		.setColor("RED");
	const noticEEEe2 = new Discord.MessageEmbed()
		.setDescription(
			`:x: You must mention someone to clear their warns, do something right in your life.`
		)
		.setColor("RED");
	const noticEffEEe2 = new Discord.MessageEmbed()
		.setDescription(`:x: This user didn't have any warning record, idiot`)
		.setColor("RED");
	...
	const embed = new Discord.MessageEmbed()
		.setColor("BLUE")
		.setDescription(
			`:white_check_mark: **${client.moderationdb.get(
				key,
				"warns"
