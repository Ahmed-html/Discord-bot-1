...
module.exports.run = async (client, message, args) => {
	...
	const notice3 = new Discord.MessageEmbed()
		.setDescription(`:x: I don't have permission to unmute people! So not halal mode.`)
		.setColor("RED");
	...
	const notice2 = new Discord.MessageEmbed()
		.setDescription(`:x: You cannot do this, idiot.`)
		.setColor("RED");
	...
	const embed7 = new Discord.MessageEmbed()
		...
		.setDescription("Correct Example: !unmute @Duko")
		.setColor("RED");
	if (!member) {
		message.delete();
	...
	const bruhembed = new Discord.MessageEmbed()
		.setDescription(
			`:x: **${member.username}#${member.discriminator}** has not been muted, do something right in your life.`
		)
		.setColor("RED");
