...
module.exports.run = async (client, msg, args) => {
	...
	const notice2 = new Discord.MessageEmbed()
		.setDescription(`:x: Idiot, you cannot ban yourself!`)
		.setColor("RED");
	...
	const dsfdsfsdf = new Discord.MessageEmbed()
		.setDescription(
			`:x: That member has roles higher or equal to you, do something right in your life.`
		)
		.setColor("RED");
	const sdfsdfsdfsd = new Discord.MessageEmbed()
		.setDescription(
			`:x: That member has roles higher or equal to me, do something right in your life`
		)
		.setColor("RED");
	...
	if (reason.length < 1) reason = "No reason given, do something right in your life.";
